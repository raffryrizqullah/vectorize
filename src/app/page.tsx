  ...
  return (
    <div className="bg-white">
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        >
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              ...
              <CubeTransparentIcon aria-hidden="true" className="h-8 w-8 text-indigo-600" />
            </a>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
